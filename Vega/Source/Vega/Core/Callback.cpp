...
Vega::Core::Callback::Callback(Window *window, Application *application) :
    mWindow(window),
...
bool Vega::Core::Callback::OnWindowResize(const Event::Event &event) {
  ...
  mApplication->mWindowSize = {windowResizeEvent.Width, windowResizeEvent.Height};
...
bool Vega::Core::Callback::OnMousePosition(const Event::Event &event) {
  ...
  mApplication->mMousePosition = {mousePositionEvent.X, mousePositionEvent.Y};
...
bool Vega::Core::Callback::OnMouseScroll(const Event::Event &event) {
  ...
  mApplication->mMouseScoll = {mouseScrollEvent.X, mouseScrollEvent.Y};
